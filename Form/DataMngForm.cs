    ...
    public partial class DataMngForm : Form
    {
        ...
        private void btn_txt_Click(object sender, EventArgs e)
        {
            try {
                ...
                StreamWriter ConstructorStreamWriter = new StreamWriter("C:/temp/fichadas.txt", append); 
                ...
                if (checkBox_timePeriod.Checked == true) {
                    ...
                    dt_periodLog.Columns.Add("User ID", System.Type.GetType("System.String"));
                    dt_periodLog.Columns.Add("Verify Date", System.Type.GetType("System.String"));
                    dt_periodLog.Columns.Add("Verify Type", System.Type.GetType("System.String"));   // Int32
                    dt_periodLog.Columns.Add("Verify State", System.Type.GetType("System.String"));  // Int32
                    dt_periodLog.Columns.Add("WorkCode", System.Type.GetType("System.Int32"));  //  Int32
                    ...
                    // Escribo en txt
                    ConstructorStreamWriter.WriteLine("-- Cierre archivo --");
                    ...
                    dt_period.Columns.Add("User ID", System.Type.GetType("System.String"));
                    dt_period.Columns.Add("Verify Date", System.Type.GetType("System.String"));
                    dt_period.Columns.Add("Verify Type", System.Type.GetType("System.String"));  // Int32
                    dt_period.Columns.Add("Verify State", System.Type.GetType("System.String")); // Int32
                    dt_period.Columns.Add("WorkCode", System.Type.GetType("System.Int32")); // Int32



                    // Escribo en txt
                    //ConstructorStreamWriter.WriteLine("Inicio Archivo ver 5   : ");

                    int iColCount = dt_period.Columns.Count;

                    // Escribiendo las Columnas del DataTable.
                    //for (int i = 0; i < iColCount; i++)
                    //{
                    //    ConstructorStreamWriter.Write(dt_period.Columns[i]);
                    //    if (i < iColCount - 1)
                    //    {
                    //        ConstructorStreamWriter.Write("    ");
                    //    }
                    //}
                    ...
                    //ConstructorStreamWriter.WriteLine(dt_period.Rows);
                    ...
                    foreach (DataRow dr in dt_period.Rows)
                    {
                        for (int i = 0; i < iColCount; i++)
                        {
                            ...
                            {
                                ConstructorStreamWriter.Write(dr[i].ToString());
                            }
                        ...
                        ConstructorStreamWriter.Write(ConstructorStreamWriter.NewLine);
                    }

                    // Escribo en txt
                    //ConstructorStreamWriter.WriteLine("---------< Fin archivo >-------");
                    //----------------------------------------//
                }
                Cursor = Cursors.Default;
                ...
                //Close the     
                ConstructorStreamWriter.Close();
            } catch(Exception except2) {
                Console.WriteLine("Exception: " + except2.Message);
            } finally {
