    ...
    public partial class TerminalForm : Form
    {
        ...
        * *******************************************************************************************************************************************/
        ...
        private void btnTCPConnect_Click(object sender, EventArgs e)
        {
            ...
            {
                btnTCPConnect.Text = "Conectar reloj ...";
                btnTCPConnect.Refresh();
        ...
        private void button1_Click(object sender, EventArgs e) {
            Cursor = Cursors.WaitCursor;
            int ret = Terminal.SDK.sta_ConnectTCP(Terminal.lbSysOutputInfo, txtIP2.Text.Trim(), txtPort2.Text.Trim(), txtCommKey11.Text.Trim());
            ...
            if (ret == 1)
            {
                ...
                this.txtCommKey11.ReadOnly = true;
                ...
                btnTCPConnect2.Text = "Desconectar";
                btnTCPConnect2.Refresh();

            }
            else if (ret == -2)
            {
                btnTCPConnect2.Text = "Conectar reloj ...";
                btnTCPConnect2.Refresh();
                this.txtDeviceID1.ReadOnly = false;
                this.txtIP2.ReadOnly = false;
                this.txtPort2.ReadOnly = false;
                this.txtCommKey11.ReadOnly = false;
