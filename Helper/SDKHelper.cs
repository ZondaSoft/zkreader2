...
*/
        ...
        */
        ...
        public int sta_readAttLog(ListBox lblOutputInfo, DataTable dt_log)
        {
            ...
            string idwMonth2 = "0";
            string idwHour2 = "0";
            string cerowMinute = "0";
            string idwVerifyMode2 = "0";
            string idwInOutMode2 = "0";
            ...
            if (axCZKEM1.ReadGeneralLogData(GetMachineNumber()))
            {
                            ...
                            out idwInOutMode, out idwYear, out idwMonth, out idwDay, out idwHour, out idwMinute, out idwSecond, ref idwWorkcode))//get records from the memory
                {
                    ...
                    if (sdwEnrollNumber.Length == 1) { 
                        dr["User ID"] = "00000" + sdwEnrollNumber;
                    } else if (sdwEnrollNumber.Length == 2) {
                        dr["User ID"] = "0000" + sdwEnrollNumber;
                    } else if (sdwEnrollNumber.Length == 3) {
                        dr["User ID"] = "000" + sdwEnrollNumber;
                    } else if (sdwEnrollNumber.Length == 4) {
                        dr["User ID"] = "00" + sdwEnrollNumber;
                    } else if (sdwEnrollNumber.Length == 5) {
                        dr["User ID"] = "0" + sdwEnrollNumber;
                    } else {
                    ...
                    if (idwInOutMode > 9 && idwInOutMode < 100) {
                        idwInOutMode2 = "0";
                    } else if (idwInOutMode < 10) {
                        idwInOutMode2 = "00";
                    } else {
                        idwInOutMode2 = "";
                    }

                    dr["Verify Date"] = idwDay2 + idwDay + "/" + idwMonth2 + idwMonth + "/" + idwYear + " " + idwHour2 + idwHour + ":" + cerowMinute + idwMinute;
                    dr["Verify Type"] = idwVerifyMode2 + idwVerifyMode;
                    dr["Verify State"] = idwInOutMode2 + idwInOutMode;
